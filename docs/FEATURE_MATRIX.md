...
| Search | 80% | Column View has an owned toggle, bounded recursive search, visible results, and explicit Enter behavior | Search is intentionally bounded to four directory levels and 200 matches | Add cancellation and richer result context | Button/Ctrl+F toggle search reliably; Enter submits the query unless a suggestion is explicitly chosen |
